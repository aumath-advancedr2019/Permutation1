...
p <- permutation_mean(test,"names","value","Group1","Group2", no_perm=10000, nice_plot=ggplot_status, progress=FALSE)
p
```
...
```{r fig.width=6, fig.height=4, fig.align='center'}
p <- permutation_median(test,"names","value","Group1","Group2", no_perm=10000, nice_plot=ggplot_status, progress=FALSE)
p
```
...
```{r echo=FALSE, r fig.width=6, fig.height=4, fig.align='center'}
if (ggplot_status){
data %>% ggplot(aes(x,y))+
  geom_point()+
  theme_minimal()
...
```{r fig.width=6, fig.height=4, fig.align='center'}
p <- permutation_lm(data, "x","y","quadratic", "linear", nice_plot=ggplot_status, progress=FALSE)
p
```
...
```{r fig.width=6, fig.height=4, fig.align='center'}
p <- permutation_lm(data, "x","y","cubic","quadratic", nice_plot=ggplot_status, progress=FALSE)
p
```
