...
```{r}
p <- permutation_mean(test,"names","value","Group1","Group2", no_perm=10000, nice_plot = TRUE)
p
```
...
```{r}
p <- permutation_median(test,"names","value","Group1","Group2", no_perm=10000, nice_plot = TRUE)
p
```
...
```{r}
p <- permutation_lm(data, "x","y","quadratic", "linear", nice_plot=T)
p
```
...
```{r}
p <- permutation_lm(data, "x","y","cubic","quadratic", nice_plot=T)
p
```
